...
class ScrollMachineHistoryTable extends React.Component {
  constructor(props) {
    super(props);
      ...
      render: record => (
        <>
          <div>
            ...
            <Link
              style={{ color: "#79C908" }}
              to={`/machineHistories/view/${record.id}/${record.emp_code}/${record.complain_no}`}
            >
              View
            </Link>{" "}
            <span style={{ marginLeft: "10px" }} />
...
export default ScrollMachineHistoryTable;
