...
class AccountScrollTable extends React.Component {
  constructor(props) {
    super(props);
      ...
      <Card bordered={false}>
        <h2 style={{ paddingBottom: "10px" }}>
          {this.props.title && (
            ...
            >
              {this.props.module && (
                <Link style={{ color: "#fff" }} to={`/account/new`}>
...
export default AccountScrollTable;
