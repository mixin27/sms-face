...
class ScrollScheduleTable extends React.Component {
  constructor(props) {
    super(props);
      ...
      render: record => (
        <>
          <div>
            <Link
              style={{ color: "#79C908" }}
              to={`schedules/schedule/view/${record.id}/${record.complain_no}`}
            >
              View
            </Link>{" "}
            ...
            <Link
              style={{ color: "#1890FF" }}
              to={`/schedules/schedule/edit/${record.id}/${record.complain_no}`}
            >
              Edit
            </Link>{" "}
            <span style={{ marginLeft: "10px" }} />
...
export default ScrollScheduleTable;
