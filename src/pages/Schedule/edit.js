    ...
    this.props.form.validateFields(async (err, values) => {
      if (!err) {
        const schedule = {
          ...
          schedule_job_status: values.schedule_job_status,
        ...
        this.props.putSchedule(schedule, this.state.data.id);
                  ...
                  <Col xs={24} sm={24} md={6} lg={6}>
                    <FormItem label="Service Charge">
                      {getFieldDecorator("service_charge", {
                        initialValue: data.service_charge,
                        rules: [
                          {
                            required: true,
                  ...
                  <Col xs={24} sm={24} md={6} lg={6}>
                    <FormItem label="Inspection">
                      {getFieldDecorator("inspection", {
                        initialValue: data.inspection == "Yes" ? 1 : 0,
                        rules: [
                          {
                            required: true,
                  ...
                  <Col xs={24} sm={24} md={6} lg={6}>
                    <FormItem label="Watching List">
                      {getFieldDecorator("watching_list", {
                        initialValue: data.watching_list == "Yes" ? 1 : 0,
                        rules: [
                          {
                            required: true,
                  ...
                  <Col xs={24} sm={24} md={6} lg={6}>
                    <FormItem label="Job Status">
                      {getFieldDecorator("job_status", {
                        initialValue: data.schedule_job_status,
                        rules: [
                          {
                            required: true,
                  ...
                  <Col xs={24} sm={24} md={6} lg={6}>
                    <FormItem label="Job Title">
                      {getFieldDecorator("schedule_job_title", {
                        initialValue: data.schedule_job_title,
                        rules: [
                          {
                            required: true,
                  ...
                  <Col xs={24} sm={24} md={6} lg={12}>
                    <FormItem label="Job Description :">
                      {getFieldDecorator("schedule_job_description", {
                        initialValue: data.schedule_job_description,
                        rules: [
                          {
                            require: false,
                            message: "Description"
